<?php
session_start();
// donation_process.php - Process donation form submission
...
<body>
    ...
    <main>
        <section class="donation-form-section" id="donation">
            ...
            <form class="donation-form" method="post" action="donation_process.php" id="donationForm">
                ...
                <input type="submit" class="donate-btn" name="donation" value="Donate Now"></input> 
