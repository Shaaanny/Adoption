            ...
            <div class="pet-grid">
                ...
                <div class="pet-card">
                    ...
                    <div class="pet-info">
                        ...
                        <a href="form.html" class="adopt-btn"><i class="fas fa-paw"></i> Adopt </a>
                    </div>
                </div>
                <!-- Pet Card 2 -->
                <div class="pet-card">
                    ...
                    <div class="pet-info">
                        ...
                        <p><strong>Adoption Fee:</strong> ₱420</p>
                        <a href="form.html" class="adopt-btn"><i class="fas fa-paw"></i> Adopt</a>
                    </div>
                </div>
                <!-- Pet Card 3 -->
                <div class="pet-card">
                    ...
                    <div class="pet-info">
                        ...
                        <p><strong>Adoption Fee:</strong> ₱400</p>
                        <a href="form.html" class="adopt-btn"><i class="fas fa-paw"></i> Adopt</a>
                    </div>
                </div>
                <!-- Pet Card 4 -->
                <div class="pet-card">
                    ...
                    <div class="pet-info">
                        ...
                        <p><strong>Age:</strong> 1 year</p>
                        <p><strong>Adoption Fee:</strong> $580</p>
                        <a href="form.html" class="adopt-btn"><i class="fas fa-paw"></i> Adopt</a>
                    </div>
                </div>
                <!-- Pet Card 5 -->
