...
<header>
    ...
    <section class="hero">
        <h1>Where Love Finds its Way Home.<br>
    ...
    <section class="featured-pets">
        ...
        <div class="pet-cards">
            <div class="pet-card">
                ...
                <a href="form.php" class="adopt-btn"><i class="fas fa-paw"></i> Adopt Bella</a>
            </div>
            <div class="pet-card">
                ...
                <a href="form.php" class="adopt-btn"><i class="fas fa-paw"></i> Adopt Max</a>
            </div>
            <div class="pet-card">
                ...
                <a href="form.php" class="adopt-btn"><i class="fas fa-paw"></i> Adopt Luna </a>
            </div>
        </div>
    </section>
    ...
    <footer class="footer">
        <div class="footer-container">
            ...
            <div class="footer-section contact">
                <h3>Contact Us</h3>
                <p><i class="fas fa-map-marker-alt"></i> Block 39 Lot 19, Grand Villas, Marilao, Bulacan</p>
                <p><i class="fas fa-phone"></i> +63 (915) 133-4602</p>
                <p><i class="fas fa-envelope"></i> support@paw-portal.com</p>
            </div>
        </div>
